        ...
        return (
            <div>
                ...
                <div className="img-wrap flx">
                    <Link to = {`/products/${this.props.id}`} className='link' onClick={ ()=> { this.props.click(this.props.id); this.props.check && this.props.close(); this.props.setHistory(`/products/${this.props.id}`)} }>
